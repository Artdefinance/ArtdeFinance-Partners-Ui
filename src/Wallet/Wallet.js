...
export default class Wallet extends React.Component {
  ...
  render() {
    const { isToggleOn1, isToggleOn2, isToggleOn3, isToggleOn4, isToggleOn5 } = this.state;
    const style = {
      open: {
        opacity: 1,
        y: 0,
            ...
            <div className="wallet__box">
              <div className="wallet-info">
                <div className="wallet-info__list">
                  ...
                  <div className="wallet-info__item">
                    <div className="wallet-info__header">
                      <p className="wallet-info__header-text">Total Sales Vaule</p>
                      <div className="question-bubble">
                        <button
                          type="button"
                          onClick={this.handleClick}
                    ...
                    <div className="wallet-info__box">
                      <p className="wallet-info__count-number">999,999,999.00</p>
                  ...
                  <div className="wallet-info__item">
                    <div className="wallet-info__header">
                      <p className="wallet-info__header-text">Curation Reward</p>
                      <div className="question-bubble">
                        <button
                          type="button"
                          onClick={this.handleClick}
                  ...
                  <div className="wallet-info__item">
                    <div className="wallet-info__header">
                      <p className="wallet-info__header-text">Curation Revenue</p>
                      <div className="question-bubble">
                        <button
                          type="button"
                          onClick={this.handleClick}
            ...
            <div className="wallet__list">
              <div className="wallet-data">
                <div className="wallet-data__filter">
                  <Dropdown dropWidth="216px" dropHeight="60px" dropTitle="Artwork Owner" content={Content1} dropFontSize="16px" dropFontColor="#000000" />
                </div>
