...
export default class View extends React.Component {
  ...
  render() {
    const { isClickSeemore } = this.state;
    return (
          ...
          <div className="side-view">
            ...
            <div className="side-view__content">
              ...
              <div className="side-view__content-box">
                ...
                <div className={isClickSeemore ? 'side-view__description--active' : 'side-view__description'}>
                  <p>
                  ...
                  <button type="button" className="side-view__more" onClick={this.moreHandler}>See more</button>
                </div>
